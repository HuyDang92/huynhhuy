      ...
      <>
         ...
         <div>
            <div className="mt-[90px]" id="smooth-content">
               <div className="w-[95vw] lg:w-[1400px] relative z-0 mx-auto h-[300px] md:h-[400px] lg:h-[600px] mb-20">
                  ...
                  <div className="absolute top-10 w-full z-0 text-center left-1/2 -translate-x-1/2 text-white">
                     <h1 className="lg:text-7xl text-2xl md:text-5xl">Hi, I'm Dang Huynh Huy</h1>
               ...
               <div className="aboutMe" id="aboutMe">
                  <div className="absolute h-[470px] md:overflow-hidden flex md:flex-row flex-col w-full z-0 text-white">
                     <div className="md:w-[60%] md:p-16 p-5">
                        <h1 className="lg:text-6xl md:text-5xl text-2xl mb-5">About me</h1>
                        <p className="h-[270px] overflow-y-auto font-sans font-semibold md:text-lg">
                     ...
                     <img src="/me.png" className="md:w-auto w-60 mx-auto" alt="" />
                  </div>
               </div>
               <div className="story my-20 w-[95vw] lg:w-[75rem] relative mx-auto">
                  ...
                  <div className="w-full flex mt-14">
                     ...
                     <div className="lg:w-1/2 w-full text-[#1D232A] space-y-2 rounded-3xl bg-gradient-to-b from-[#E6F9FF] to-white p-5 md:p-10">
                        <p>
               ...
               <div className="pt-40">
                  <div className="contact rounded-3xl text-white text-center md:p-20 p-10 flex flex-col justify-center">
                     ...
                     <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
                        ...
                        <a href="https://drive.google.com/file/d/1ZOeQ-40H8pjaiB5WdmlFPPdUFtEBShZu/view?usp=sharing" target="_blank">
