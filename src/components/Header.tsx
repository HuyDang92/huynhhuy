...
function Header() {
   ...
   return (
      <header className="h-[90px] w-[1300px] mx-auto flex justify-between items-center">
         <h1 className=" text-3xl">D.H.HUY</h1>
         ...
         <div className="drawer w-fit">
            ...
            <div className="drawer-content w-fit">
               <label htmlFor="my-drawer" className="btn px-1 hover:scale-110 bg-transparent border-none shadow-none hover:bg-transparent">
